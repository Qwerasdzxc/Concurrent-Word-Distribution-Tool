...
public class FileInputView {
    ...
    private void linkCruncher(Cruncher cruncher) {
        ...
        PipelineManager.getInstance().attachFileInputComponentToCruncherComponent(fileInput.getDisk(), cruncher.getArity());
    }
    ...
    public void removeLinkedCruncher(Cruncher cruncher) {
        ...
        PipelineManager.getInstance().detachFileInputComponentFromCruncherComponent(fileInput.getDisk(), cruncher.getArity());
    }
    ...
    private void addDirectory() {
        ...
        if (fileDirectory != null && fileDirectory.exists() && fileDirectory.isDirectory()) {
            ...
            PipelineManager.getInstance().addDirectoryToFileInputComponent(fileInput.getDisk(), directory);
        }
    }
    ...
    private void removeDirectory(Directory directory) {
        ...
        PipelineManager.getInstance().removeDirectoryFromFileInputComponent(fileInput.getDisk(), directory);
    }
    ...
    private void removeDiskInput() {
        PipelineManager.getInstance().removeFileInputComponent(fileInput.getDisk());
